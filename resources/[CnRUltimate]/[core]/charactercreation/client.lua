...
function AddMenuGender(menu)
    ...
    menu.OnListChange = function(sender, item, index)
		-- print(item) -- Pode comentar isto se não precisar de debug
        if item == genderitem then
            ...
            -- ALTERAÇÃO AQUI: Envolver a atualização numa thread separada
            Citizen.CreateThread(function()
			    RefreshModel()
            end)
        end
...
exports("StartCharacterCreation", CharCreatorAnimation)
